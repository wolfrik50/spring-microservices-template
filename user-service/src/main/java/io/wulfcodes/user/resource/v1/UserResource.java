...
import io.wulfcodes.common.model.exchange.UserRequest;
...
public class UserResource {
    ...
    public ResponseEntity<UserResponse> fetchAllUsers(
        ...
        try {
            List<UserData> users = userService.getUsers(includeRatings);
    ...
    public ResponseEntity<UserResponse> fetchUser(
        ...
        UserData fetchedUser = userService.getUserById(id, includeRatings);
        return ResponseEntity.ok(UserResponse.successResponse(fetchedUser));
    }

    @PutMapping("/{userId}")
    public ResponseEntity<GenericResponse> changeUser(@PathVariable(USER_ID) String id, @RequestBody UserData updatedUser) {
        try {
    ...
    public ResponseEntity<GenericResponse> removeUser(@PathVariable(USER_ID) String id) {
        try {
